...
categories: [翻译]
---
![title](http://img.blog.csdn.net/20170810182808207?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvc3Vuc2hpbmU5NDAzMjY=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
![新旧浏览器中圆角效果截图](https://user-gold-cdn.xitu.io/2017/7/31/b1e6b91145d7582d3cbadae5b0696b22)大多数的浏览器显示 `border-radius: 1em` 如图片的右边所示。然而，Internet Explorer 6、7 和 8 不会设置圆角，显示效果如图片的左边所示。看看这个例子 [codepen.io/jensimmons/pen/EydmkK](http://codepen.io/jensimmons/pen/EydmkK?editors=1100) 
您不需要为此进行功能查询。
...
![`initial-letter`这个例子在 Safari 9 下面的截图](https://user-gold-cdn.xitu.io/2017/7/31/0f6e72830b986198bf3d9f9f28749da8)
这是我们的 `initial-letter` 的例子在 Safari 9 下的显示。现在让我们看看其他浏览器会发生什么…

![`initial-letter` 这个例子在其他浏览器下面的截图](https://user-gold-cdn.xitu.io/2017/7/31/e2143c65765e51569e4a65737e7ed540)哦，不，这在其他浏览器看起来非常糟糕。这是不能接受的。我们不想改变字母的颜色，或者增加一个空白，或者让它加粗，除非它通过 `initial-letter` 属性被设置的更大了一些。我们需要一种方法来测试浏览器是否支持 `initial-letter`，并且只在颜色、粗细和空白处应用更改。进入特征查询。
```    
...
![使用之前和之后的对比](https://user-gold-cdn.xitu.io/2017/7/31/451c01c810aa87f05ca2d360eb9dea78)截屏的左边是来自 Safari 9。其它浏览器展现的结果显示为右边。你可以在 [codepen.io/jensimmons/pen/ONvdYL](http://codepen.io/jensimmons/pen/ONvdYL?editors=1100) 看到这个测试的代码。
...
[![Can I use 网站支持特征查询的截图](https://user-gold-cdn.xitu.io/2017/7/31/8cbf85979f4fc31fe9a47c78105a4ae2)](http://caniuse.com/#feat=css-featurequeries)特征查询的支持可以查看：[特征查询在 Can I Use 上的结果](http://caniuse.com/#feat=css-featurequeries)
...
[![Can I Use 网站中关于 Object-fit 支持的截图](https://user-gold-cdn.xitu.io/2017/7/31/b67035baf188a52dcb8f0727a03de052)](http://caniuse.com/#feat=object-fit)来看一下支持情况 [Object Fit 在 Can I Use 上的结果](http://caniuse.com/#feat=object-fit)
